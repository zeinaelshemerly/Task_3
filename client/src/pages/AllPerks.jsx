...
export default function AllPerks() {
  ...
  // 🟢 useEffect Hook #1: Load all perks initially (when component mounts)
  useEffect(() => {
    loadAllPerks()
  }, [])

  // 🟢 useEffect Hook #2: Auto-search whenever searchQuery or merchantFilter changes
  useEffect(() => {
  ...
  // 🟢 Update unique merchant list whenever perks update
  useEffect(() => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={e => setMerchantFilter(e.target.value)} // 🟢 added
              >
